...
docker build -t n8goody/chesscam-pgn:$VERSION -t n8goody/chesscam-pgn:dev-nate .

# Push both tags
docker push n8goody/chesscam-pgn:$VERSION
docker push n8goody/chesscam-pgn:dev-nate
